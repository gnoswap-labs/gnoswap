...
ADDR_USER1 := g16a7etgm9z2r653ucl36rj0l2yqcxgrz2jyegzx

.PHONY: test-wugnot-fee-collection
test-wugnot-fee-collection: setup-test-accounts create-test-pool mint-test-position execute-swaps collect-fees stake-token-1

.PHONY: setup-test-accounts
setup-test-accounts:
	$(info ************ Step 1: Setting up test accounts ************)
	# Send ugnot to test accounts
	@echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_TEST_ADMIN) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 100000000ugnot -gas-wanted 100000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx send -send 500000000ugnot -to $(ADDR_USER1) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 100000000ugnot -gas-wanted 100000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx send -send 500000000ugnot -to $(ADDR_TEST_ADMIN) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 100000000ugnot -gas-wanted 100000000 -memo "" gnoswap_admin
	...
	@echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_USER1) -args 100000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 100000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
