...
send-ugnot-must:
	...
	@echo "" | gnokey maketx send -send 10000000000ugnot -to $(ADDR_GNOSWAP) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1
	@echo "" | gnokey maketx send -send 10000000000ugnot -to $(ADDR_ADMIN) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1
	@echo "" | gnokey maketx send -send 10000000000ugnot -to $(ADDR_TEST) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1
	@echo
...
transfer-ugnot:
	$(info ************ send ugnot to necessary accounts ************)
	@[ -n "$(ADDR_TEST_ADMIN)" ] && echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_TEST_ADMIN) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_TEST_ADMIN (not set)"
	@[ -n "$(ADDR_USER_1)" ] && echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_USER_1) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_USER_1 (not set)"
	@[ -n "$(ADDR_USER_2)" ] && echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_USER_2) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_USER_2 (not set)"
	@[ -n "$(ADDR_USER_3)" ] && echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_USER_3) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_USER_3 (not set)"
	@[ -n "$(ADDR_USER_4)" ] && echo "" | gnokey maketx send -send 100000000ugnot -to $(ADDR_USER_4) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_USER_4 (not set)"
	@echo

transfer-gns:
	$(info ************ transfer 1_000_000_000 GNS to accounts ************)
	@[ -n "$(ADDR_TEST_ADMIN)" ] && echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_TEST_ADMIN) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_TEST_ADMIN (not set)"
	@[ -n "$(ADDR_USER_1)" ] && echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_USER_1) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_1 (not set)"
	@[ -n "$(ADDR_USER_2)" ] && echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_USER_2) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_2 (not set)"
	@[ -n "$(ADDR_USER_3)" ] && echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_USER_3) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_3 (not set)"
	@[ -n "$(ADDR_USER_4)" ] && echo "" | gnokey maketx call -pkgpath $(GNS_PATH) -func Transfer -args $(ADDR_USER_4) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_4 (not set)"
	@echo

transfer-usdc:
	$(info ************ transfer 1_000_000_000 USDC to accounts ************)
	@[ -n "$(ADDR_TEST_ADMIN)" ] && echo "" | gnokey maketx call -pkgpath $(USDC_PATH) -func Transfer -args $(ADDR_TEST_ADMIN) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_TEST_ADMIN (not set)"
	@[ -n "$(ADDR_USER_1)" ] && echo "" | gnokey maketx call -pkgpath $(USDC_PATH) -func Transfer -args $(ADDR_USER_1) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_1 (not set)"
	@[ -n "$(ADDR_USER_2)" ] && echo "" | gnokey maketx call -pkgpath $(USDC_PATH) -func Transfer -args $(ADDR_USER_2) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_2 (not set)"
	@[ -n "$(ADDR_USER_3)" ] && echo "" | gnokey maketx call -pkgpath $(USDC_PATH) -func Transfer -args $(ADDR_USER_3) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin || echo "Skipping ADDR_USER_3 (not set)"
...
faucet-ugnot:
	$(info ************ send ugnot to necessary accounts ************)
	@[ -n "$(ADDR_TEST_ADMIN)" ] && @echo "" | gnokey maketx send -send 10000000000ugnot -to $(ADDR_TEST_ADMIN) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 100000000 -memo "" test1 || echo "Skipping ADDR_TEST_ADMIN (not set)"
	@echo
...
mint-gns-ugnot:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoland/wugnot -func Deposit -send "20000000ugnot" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	# APPROVE FISRT
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoland/wugnot -func Approve -args $(ADDR_POSITION) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo

	# THEN MINT
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/position -func Mint -args "gno.land/r/gnoswap/gns" -args "gno.land/r/gnoland/wugnot" -args 3000 -args "-49980" -args "49980" -args 20000000 -args 20000000 -args 1 -args 1 -args $(TX_EXPIRE) -args $(ADDR_ADMIN) -args "" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
decrease-liquidity-position-01:
	$(info ************ decrease position(1) liquidity ugnot:gns:3000 ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/position -func DecreaseLiquidity -args 1 -args 12345678 -args 0 -args 0 -args $(TX_EXPIRE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo


# create external incentive
create-external-incentive:
	$(info ************ create external incentive [gns] => ugnot:gns:3000 ************)
	# APPROVE REWARD (+ DepositGNS)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gns -func Approve -args $(ADDR_STAKER) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
set-pool-tier-gns-wugnot:
	$(info ************ set pool tier 1 for ugnot:gns:3000 ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/staker -func SetPoolTier -args "gno.land/r/gnoland/wugnot:gno.land/r/gnoswap/gns:3000" -args 1 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
swap-exact-in-single-gns-wugnot:
	$(info ************ swap gns -> wgnot, exact_in_single ************)
...
# multihop setup (GNS -> WUGNOT -> USDC)
setup-multihop-gns-usdc:
	$(info ************ setup wgnot:usdc pool for multihop ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoland/wugnot -func Deposit -send "20000000ugnot" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/test_token/test_usdc -func Approve -args $(ADDR_POOL) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoland/wugnot -func Approve -args $(ADDR_POOL) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/pool -func CreatePool -args "gno.land/r/gnoland/wugnot" -args "gno.land/r/gnoswap/test_token/test_usdc" -args 3000 -args 79228162514264337593543950337 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -max-deposit=10000000000ugnot -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/position -func Mint -args "gno.land/r/gnoswap/test_token/test_usdc" -args "gno.land/r/gnoland/wugnot" -args 3000 -args "-49980" -args "49980" -args 20000000 -args 20000000 -args 1 -args 1 -args $(TX_EXPIRE) -args $(ADDR_ADMIN) -args "" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo


# swap exact in multihop
swap-exact-in-multihop-gns-usdc:
	$(info ************ swap gns -> wgnot -> usdc, exact_in ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gns -func Approve -args $(ADDR_ROUTER) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/test_token/test_usdc -func Approve -args $(ADDR_ROUTER) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/router -func ExactInSwapRoute -args "gno.land/r/gnoswap/gns" -args "gno.land/r/gnoswap/test_token/test_usdc" -args 50000 -args "gno.land/r/gnoswap/gns:gno.land/r/gnoland/wugnot:3000*POOL*gno.land/r/gnoland/wugnot:gno.land/r/gnoswap/test_token/test_usdc:3000" -args "100" -args "0" -args $(TX_EXPIRE) -args "" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
collect-swap-fee:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/position -func CollectFee -args 1 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
delegate:
	...
	# APPROVE FIRST
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gns -func Approve -args $(ADDR_GOV_STAKER) -args $(MAX_APPROVE) -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin

	# DELEGATE
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/staker -func Delegate -args $(ADDR_GNOSWAP) -args 5000000000 -args "" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo

# redelegate gns
redelegate:
	$(info ************ redelegate 1_000_000_000 from self to self ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/staker -func Redelegate -args $(ADDR_GNOSWAP) -args $(ADDR_GNOSWAP) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
undelegate:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/staker -func Undelegate -args $(ADDR_GNOSWAP) -args 1000000000 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
collect-undelegated:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/staker -func CollectUndelegatedGns -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
propose-text:
	$(info ************ propose text ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/governance -func ProposeText -args "title_for_text" -args "desc_for_text" -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
cancel-text:
	$(info ************ cancel text ************)
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/governance -func Cancel -args 1 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
vote-community:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/governance -func Vote -args 2 -args true -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
...
execute-community:
	...
	@echo "" | gnokey maketx call -pkgpath gno.land/r/gnoswap/gov/governance -func Execute -args 2 -insecure-password-stdin=true -remote $(GNOLAND_RPC_URL) -broadcast=true -chainid $(CHAINID) -gas-fee 1000000ugnot -gas-wanted 1000000000 -memo "" gnoswap_admin
	@echo
