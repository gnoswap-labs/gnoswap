...
Attempts to register a referral relationship and returns the effective referrer.
On registration failure, returns the previously stored referrer, or an empty string.
