...
### Changed
- Reduce duplicate governance-staking protocol-fee settlement work without changing public APIs, storage layout, or reward rounding. Settlement still scans the historical token set.
